            ...
            <div class="card-body">
                <div class="form-row">
                    <div class="col-lg-6 col-md-12 mb-3">
                        ...
                        <input type="text" value="{{$category->title}}" name="title" class="form-control" placeholder="{{__('Enter title')}}">
                    </div>
                    <div class="col-lg-6  col-md-12 mb-3">
                ...
                <div class="form-row">
                    <div class="col-lg-12  col-md-12 mb-3">
                        ...
                        <textarea id="summary" name="summary" class="form-control" placeholder="{{__('Enter Summary')}}"> {{$category->summary}} </textarea>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-lg-6  col-md-12 mb-3">
                        <div class="form-check">
                            <input class="form-check-input" id="is_parent" name="is_parent" type="checkbox" {{$category->is_parent == 1 ? 'checked' : ''}} value="">
                    ...
                    <div class="col-lg-6  col-md-12 mb-3 parent  {{ $category->is_parent == 1 ? 'd-none' : 'd-block'}}">
                        ...
                        <select name="parent_id" class="form-control">
                            ...
                            <option value="{{$singleCategory->id}}" {{$singleCategory->id == $category->parent_id ? 'selected' : ''}}>{{$singleCategory->title}}</option>
                            @endforeach
