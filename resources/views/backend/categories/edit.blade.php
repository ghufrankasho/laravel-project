...
@section('content')
    <section class="content-header">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ str_replace('http://', 'https://', route('category.update', $category->id)) }}" method="post">
                @csrf
                @method('patch')
                <div class="card-body">
                    <div class="form-row">
                        ...
                        <div class="col-lg-6 col-md-6 mb-3">
                            ...
                            <input type="text" value="{{ $category->discount }}" name="discount" min="0"
                                max="100" class="form-control" placeholder="{{ __('Enter Discount') }}">
                        </div>
                        <div class="col-lg-6 col-md-6 mb-3">
                            <label>{{ __('Starts From') }}</label>
                            <input type="text" value="{{ $category->starts_from }}" name="starts_from"
                            class="form-control" placeholder="{{ __('Enter Starts From') }}">
                        </div>
                        <div class="col-lg-6 col-md-6 mb-3">
                            <label>{{ __('Order') }}</label>
                            <input type="number" value="{{ $category->ordr }}" name="ordr"
                            class="form-control" placeholder="{{ __('Enter Order') }}">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-lg-6  col-md-12 mb-3">
                            ...
                            @if ($category->photo)
                                <?php $explodePath = explode(',', $category->photo); ?>
                    ...
                    <div class="form-row">
                        ...
                        <div
                            ...
                            class="col-lg-6  col-md-12 mb-3 parent  {{ $category->is_parent == 1 ? 'd-none' : 'd-block' }}">
                    ...
                    <div class="col-lg-6  col-md-12 mb-3">
                        <div class="form-check">
                            <input class="form-check-input" id="is_main" name="is_main" type="checkbox"
                                {{ $category->is_main ? 'checked' : '' }} value="{{ $category->is_main}}">
                            <label class="form-check-label">{{ __('Home') }}</label>
                        </div>
                    </div>
                </div>
                <!-- /.card-body -->
